import asyncio
from typing import TYPE_CHECKING, Any, Dict, List, Optional, AsyncIterable
...
class XtAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    async def listen_for_user_stream(self, output: asyncio.Queue):
        ...
        while True:
            try:
                ...
                async for ws_response in self._iter_messages(self._ws_assistant):
                    data = ws_response.data
                    await self._process_event_message(event_message=data, queue=output)
    ...
    async def _iter_messages(self, ws: WSAssistant) -> AsyncIterable[Dict[str, Any]]:
        try:
            while True:
                try:
